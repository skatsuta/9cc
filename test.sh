...
assert 6 'int main() { int foo123=1; int bar=2+3; return foo123+bar; }'
...
assert 7 'int main() { return ret7(); } int ret7() { return 7; }'
assert 7 'int main() { return ret7(); return 8; } int ret7() { return 7; return 9; }'
assert 7 'int main() { return add2(3, 4); } int add2(int x, int y) { return x+y; }'
assert 1 'int main() { return sub2(4, 3); } int sub2(int x, int y) { return x-y; }'
assert 55 'int main() { return fib(9); }
    int fib(int x) { if (x<=1) return 1; fib(x-1) + fib(x-2); }'
...
assert 1 'int main() { return sub_char(7, 3, 3); }
